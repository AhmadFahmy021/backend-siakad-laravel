                    ...
                    <form method="POST" action="{{ route('user.update', $user) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                <label>Address</label>
                                <textarea name="adddress" class="form-control @error('address') is-invalid @enderror" data-height="150" required="">{{ $user->address }}</textarea>
                                @error('address')
                                    <div class="invalid feedback">
                                        {{ $message }}
                                    </div>
